import type { Hook, Stats, Done, Context } from 'mocha';
declare type TContext = {
    timeout(value: number): any;
};
export declare type TestFunc = (this: Context, done: Done) => Promise<void> | void;
export declare type TDescribeFunc = (this: TContext) => void;
export declare enum RunnerConstants {
...
export declare type RunnerEventNames = RunnerConstants;
export declare type RunnerListener = ((rootSuite: ISuite) => void) | (() => void) | ((...args: any[]) => void) | ((suite: ISuite) => void) | ((test: ITest) => void) | ((hook: Hook) => void) | ((test: ITest, err: any) => void);
...
export declare enum TestConstants {
    STATE_FAILED = "failed",
    STATE_PASSED = "passed",
